      ...
      <main className="grid grid-cols-1 lg:px-40 py-24 md:grid-cols-2 gap-6">
        <div className="  bg-white border-2 border-gray-200  rounded p-8">
          ...
          <div className="grid -mt-2 grid-cols-3 lg:grid-cols-4 lg:px-5 space-y-5 gap-5 w-full place-items-center">
            <img className="col-span-1" src={GrowBetterGmail} alt="GrowBetterGmail" />
            <img className="col-span-1" src={GrowBetterShopify} alt="GrowBetterShopify" />
            <img className="col-span-1" src={GrowBetterMailchimp} alt="GrowBetterMailchimp" />
            <img className="col-span-1" src={GrowBetterZapier} alt="GrowBetterZapier" />
            <img className="lg:col-start-2 col-span-1" src={GrowBetterGoogle} alt="GrowBetterGoogle" />
            <img className="col-span-1" src={GrowBetterSlack} alt="GrowBetterSlack" />
          </div>
        ...
        <div className="md:flex md:space-y-0 space-y-10 block m-auto justify-between items-center">
          <div className="text-center">
            ...
            <div className="space-x-5 md:mt-0 mt-5 space-y-5">
              ...
              />
              <Button
                className=" px-14 font-semibold text-[#fc7756] py-4"
